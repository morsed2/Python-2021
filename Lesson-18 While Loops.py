name =				'While Loops in Python - #18'
Filename=  			'Lesson-18 While Loops.py'
Tomboy =			'Python Programming 2021'
# YouTube Link:		https://www.youtube.com/watch?v=8OuSc0Q_4tI&list=PLCC34OHNcOtrZTjsC5qtn_X9eRAmGmGOI&index=18
#
